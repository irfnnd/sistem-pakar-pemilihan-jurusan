...
class KonsultasiUserController extends Controller
{
    ...
    public function form()
    {
        ...
        return view('user.konsultasi.form', compact('ciriCiri', 'jurusan'));
    }
    ...
    public function proses(Request $request)
    {
        ...
        return view('user.konsultasi.hasil', compact('hasil', 'konsultasi'));
    }

    public function riwayat()
    {
        $riwayatKonsultasi = Konsultasi::orderBy('created_at', 'desc')->paginate(10);
        return view('user.konsultasi.riwayat', compact('riwayatKonsultasi'));
    }
