...
<html lang="id">
  <head>
    ...
    />
    <meta name="keywords" content="sistem pakar, pemilihan jurusan, minat, bakat, forward chaining, backward chaining" />
    <meta
      name="twitter:title"
      content="EduChoice | Sistem Pakar Pemilihan Jurusan"
    />
    <meta
    ...
    />
    <meta content="./assets/img/educhoice-cover.png" property="og:image" />
    <meta content="https://educhoice-system.com" property="og:url" />
    ...
    <!-- Canonical -->
    <link rel="canonical" href="https://educhoice-system.com" />
        ...
        >
          <div class="w-60 lg:w-56 max-w-full px-5">
            ...
            >
              ...
              >
                <path
                  d="M50,29.77h40v15h-20v30h20v15h-40v-60z"
                />
                <path
